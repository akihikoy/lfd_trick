...
class TStateMachine:
  def __init__(self,start_state='', debug=False, local_obj=TContainer()):
    ...
    #State machine does not use this variable, so it's completely user defined.
    #If you prefer small memory usage, just set local_obj as None.
    self.l= local_obj
